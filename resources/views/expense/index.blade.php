                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-md-12 form-group">
                                                                        <label
                                                                            class="mb-2">{{ __('expense_category') }}
                                                                ...
                                                                <div class="form-group mt-2">
                                                                    <label
                                                                        class="mb-2">{{ __('note') }}</label>
                                                                    <textarea id="note" name="note" rows="3" class="form-control"
                                                                        placeholder="{{ __('enter_your_note') }}">{{ $expense->note }}</textarea>
                                                                    @error('note')
                ...
                <form action="{{ route('expense.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group mt-2">
                                <label class="mb-2">{{ __('warehouse') }} <span
                                        class="text-danger">*</span></label>
                                <select name="warehouse_id" class="form-control">
                                    <option disabled selected>{{ __('select_a_option') }}</option>
                                    @foreach ($warehouses as $warehouse)
